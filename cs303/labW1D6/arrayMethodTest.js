...
describe("filter practice", function () {
    ...
    it("includes even number", function () {
        assert.strictEqual(includesEvenNum([3,6,2,3,4,5]), true);
        assert.strictEqual(includesEvenNum([3,5,7,11,23]), false);
    });

    /* complete the following similar to includes even test */
    
    it("includes even age true or false",function(){
        assert.strictEqual(includesEvenAge([{ name: "Sam", age: 15 }, 
        { name: "William", age: 6 }, 
        { name: "Lucy", age: 13 }, 
        { name: "Barney", age: 80 }]), true);
        assert.strictEqual(includesEvenAge([{ name: "Sam", age: 15 }, 
        { name: "William", age: 11 }, 
        { name: "Lucy", age: 13 }, 
